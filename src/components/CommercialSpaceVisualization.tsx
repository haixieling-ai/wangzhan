...
/* 自动识别 commercial 后缀图片 */
const commercialImages = [
  `${PROJECT_04_BASE}/commercial-01.jpg`,
  `${PROJECT_04_BASE}/commercial-02.jpg`,
  `${PROJECT_04_BASE}/commercial-03.jpg`,
  `${PROJECT_04_BASE}/commercial-04.jpg`,
  `${PROJECT_04_BASE}/commercial-05.jpg`,
  `${PROJECT_04_BASE}/commercial-06.jpg`,
];
